    ...
    <div class="navbar-default sidebar" role="navigation">
      <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
          ...
          <li>
            <a class="<?php echo ($active == 'agentsj') ? 'active' : ''; ?>" href="/administrator/agentsj"><i
                  class="fa fa-user fa-fw"></i> 代理审核</a>
          </li>
          <li>
          ...
          <li>
            <a class="<?php echo ($active == 'zytongdao') ? 'active' : ''; ?>"
               href="/administrator/zytongdao"><i
                  class="fa fa-bug fa-fw"></i>中云通道设置</a>
          </li>
          <li>
            <a class="<?php echo ($active == 'system') ? 'active' : ''; ?>"
               href="/administrator/system"><i
                  class="fa fa-bug fa-fw"></i>系统设置</a>
                    ...
                    <li>
            <a class="<?php echo ($active == 'agentfee') ? 'active' : ''; ?>"
               href="/administrator/agentfee"><i
                  class="fa fa-bug fa-fw"></i>代理提成设置</a>
          </li>
          <li>
            <a class="<?php echo ($active == 'update') ? 'active' : ''; ?>"
